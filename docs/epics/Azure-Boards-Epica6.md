...
| **Parent (Feature)**   | F6.1 – Logs Estructurados y Auditoría / F6.2 – Métricas de Concurrencia y Rendimiento / F6.3 – Dashboard Técnico y de Negocio |
| **State**              | Active |
| **Area Path**          | SaludDeUna\\Backend / SaludDeUna\\DevOps / SaludDeUna\\Data / SaludDeUna\\Web |
| **Iteration Path**     | SaludDeUna\\Sprint 7 |
| **Priority**           | 1 – Critical |
...
| **Dependencias**       | HU-006 / HU-007 y emisión consistente de eventos de E1-E5 |
...
La historia consolida OBS-001, OBS-002, OBS-003 y OBS-004 en una única entrega
Must comprometida para Sprint 7.
...
- [ ] Endpoint `GET /v1/observability/dashboard/technical` implementado
- [ ] Endpoint `GET /v1/observability/dashboard/business` implementado
...
| **Dependencias**       | HU-008 |
| **Tags**               | analytics; reporting; export; could; sprint7 |
...
para revisión, archivo o soporte de retrospectivas. Esta historia es Could y solo
debe ejecutarse si las historias Must comprometidas del sprint ya están estables.
...
- GET /v1/observability/dashboard/technical
...
**Descripción:**
```
Implementar GET /v1/observability/dashboard/business con cálculo de:
- Tiempo a primera respuesta médica
- Utilidad de resumen clínico
- Red flags relevantes confirmadas
- Retención de seguimiento 7 días
...
└── 🔷 FEATURE: F6.3 – Dashboard Técnico y de Negocio (4 SP)
    ...
    │
    └── 📖 USER STORY: HU-013 – Como equipo de datos quiero exportar el tablero a un reporte semanal (3 SP)
...
**Total horas estimadas Sprint 7 (Épica 6):** 46 horas de trabajo  
...
- `GET /v1/observability/dashboard/technical` → T-008-06
- `GET /v1/observability/dashboard/business` → T-008-07
